...
func (c *goodsClient) GetGoodsInfo(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
type GoodsServer interface {
	GetGoodsInfo(context.Context, *Request) (*Response, error)
...
func (UnimplementedGoodsServer) GetGoodsInfo(context.Context, *Request) (*Response, error) {
...
func _Goods_GetGoodsInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoodsServer).GetGoodsInfo(ctx, req.(*Request))
	}
